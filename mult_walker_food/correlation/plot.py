...
corr2 = np.loadtxt('corr2_10.dat').reshape(45,5,5) 
diff_avg = diff.copy()
...
plt.plot(range(5),corr2[7,:,0]/corr2[0,0,0], label='$t=10$')
plt.plot(range(5),corr2[20,:,0]/corr2[0,0,0], label='$t=110$')
plt.plot(range(5),corr2[29,:,0]/corr2[0,0,0], label='$t=596$')
plt.plot(range(5),corr2[32,:,0]/corr2[0,0,0], label='$t=1048$')
plt.plot(range(5),corr2[44,:,0]/corr2[0,0,0], label='$t=10000$')
plt.xlim(0,2)
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.legend(fontsize=11)
