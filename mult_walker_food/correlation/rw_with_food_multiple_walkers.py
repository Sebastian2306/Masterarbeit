...
avgmsd, grid, fpercentage, diffmsd, corr1, corr2, escp = multiple_walks(100, 1, 3, 5, 100)
...
#np.savetxt('msd40.dat', avgmsd)
#np.savetxt('food40.dat', fpercentage)
#np.savetxt('diff40.dat', diffmsd)
#np.savetxt('corr1_40.dat', corr1.flatten())
#np.savetxt('corr2_40.dat', corr2.flatten())
