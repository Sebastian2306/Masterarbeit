...
#avgmsd, grid, fpercentage, diffmsd, corr1, corr2, escp = multiple_walks(100, 1000, 1, 5, 10)
fmats = np.zeros((10,100,100))
for k in range(10):
    fmats[k] = rw(100, 1000, 2, 5)[4][33]
    
np.savetxt('fmats2.dat', fmats.flatten())
#diff_avg = diffmsd.copy()   
...
#np.savetxt('msd0.dat', avgmsd)
#np.savetxt('food0.dat', fpercentage)
#np.savetxt('diff0.dat', diffmsd)
#np.savetxt('corr1_0.dat', corr1.flatten())
#np.savetxt('corr2_0.dat', corr2.flatten())
#np.savetxt('escp0.dat', escp)
